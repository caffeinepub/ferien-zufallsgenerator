...
function Confetti({ active }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 pointer-events-none z-50 overflow-hidden", children: pieces.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function ParticipantCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        boxShadow: focused || filled ? `0 12px 40px ${participant.shadowColor}` : "0 4px 20px rgba(0,0,0,0.2)",
        transform: focused ? "translateY(-4px) scale(1.02)" : "translateY(0) scale(1)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black text-white tracking-wide", children: participant.name }),
...
function ResultModal({ destination, onReset }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.67 0.09 192), oklch(0.55 0.10 200))",
            border: "4px solid oklch(0.70 0.16 50)",
            boxShadow: "0 20px 60px rgba(0,0,0,0.4), 0 0 40px oklch(0.82 0.14 82 / 0.4)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 font-semibold text-lg mb-2", children: "Euer Ferienziel ist..." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-6xl mb-3 animate-bounce", children: [
                destination.flag,
                " ",
                destination.emoji
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 font-semibold text-xl mt-2", children: destination.desc })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 mb-6 flex items-center justify-center gap-2 text-white/70 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✈️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Koffer packen & los geht's!" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, oklch(0.82 0.14 82), oklch(0.70 0.16 50))",
...
function App() {
  const [values, setValues] = reactExports.useState({ floeggi: "", saft: "", zeus: "" });
  ...
  const hasTriggered = reactExports.useRef(false);
  const allFilled = isValidNumber(values.floeggi) && isValidNumber(values.saft) && isValidNumber(values.zeus);
  const triggerRandomization = reactExports.useCallback(() => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => setConfettiActive(false), 5e3);
    }, 1800);
  }, []);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-hero font-poppins flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Confetti, { active: confettiActive }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResultModal, { destination: result, onReset: handleReset }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "pt-12 pb-8 px-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-4 animate-float", children: "✈️" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-white/80 text-lg md:text-xl font-semibold", children: "🎲 Wer entscheidet wohin? Der Zufall!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex justify-center gap-3 text-white/60 text-sm font-medium", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌊 Malaga" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🏖️ Mallorca" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌴 Valencia" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-4 pb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-black text-white", children: "🧑‍🤝‍🧑 Reisen mit den Broskies" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 mt-1 font-medium", children: "Jeder gibt eine Zahl ein – der Rest ist Schicksal!" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5 mb-8", children: PARTICIPANTS.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ParticipantCard,
              {
                participant: p,
                value: values[p.id],
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              isCalculating ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Berechne Zufallsziel..." })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  disabled: !allFilled,
                  onClick: allFilled ? triggerRandomization : void 0,
                  className: "py-4 px-10 rounded-2xl text-lg font-black transition-all duration-300",
                  style: {
                    background: allFilled ? "linear-gradient(135deg, oklch(0.82 0.14 82), oklch(0.70 0.16 50))" : "rgba(255,255,255,0.15)",
                    color: allFilled ? "oklch(0.18 0.03 220)" : "rgba(255,255,255,0.5)",
                    cursor: allFilled ? "pointer" : "not-allowed",
                    border: allFilled ? "none" : "2px dashed rgba(255,255,255,0.3)",
                    boxShadow: allFilled ? "0 8px 30px oklch(0.82 0.14 82 / 0.5)" : "none",
                    transform: allFilled ? "scale(1)" : "scale(0.98)"
                  },
                  children: allFilled ? "🎲 Ziel bestimmen!" : "Alle müssen eine Zahl eingeben..."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex justify-center gap-3", children: PARTICIPANTS.map((p) => {
                const v = values[p.id];
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: ok ? "✓" : "○" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto mt-6 grid grid-cols-3 gap-4 text-center", children: STEPS.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-2xl py-4 px-3",
          style: { background: "rgba(255,255,255,0.1)" },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-1", children: step.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm font-semibold", children: step.text })
          ]
        },
        step.id
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/50 text-sm", children: [
      "© ",
